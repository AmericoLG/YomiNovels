            ...
            <div className="relative group">
              ...
              <div className="absolute right-0 mt-2 w-48 bg-[#1e293b] rounded-lg shadow-xl border border-slate-700/50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                <div className="py-2">
                  ...
                  <Link to="/settings" className="block px-4 py-2 text-sm text-slate-300 hover:bg-slate-700/50 hover:text-white transition-colors">
                    Configuración
                  </Link>
                  <hr className="border-slate-700/50 my-2" />
                  <button className="w-full text-left px-4 py-2 text-sm text-red-400 hover:bg-slate-700/50 hover:text-red-300 transition-colors">
                    Cerrar Sesión
                  </button>
                </div>
              </div>
