...
const Register = () => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-[9999] font-sans m-0 p-0 box-border overflow-hidden">
      ...
      <div className="relative z-3 w-[520px] bg-[#162032] border-[12px] border-blue-600 rounded-[20px] p-[50px_45px] shadow-[0_0_35px_rgba(37,99,235,0.7),0_30px_60px_rgba(0,0,0,0.95)] box-border">
        {/* CABECERA */}
